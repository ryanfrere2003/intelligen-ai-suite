...
def perform_full_model_training_and_comparison_round():
    """ performs a full training round including HIL corrections for
    both SVM and DistilBERT models."""

    #tell user what kind of loop this is so they dont reset the models accidentally.
    try:
